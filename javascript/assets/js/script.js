...
document.querySelector(".result24t h4").addEventListener("click", function(){
    document.querySelector(".result24").style.display = "block";
})

document.querySelector(".result25t h4").addEventListener("click", function(){
    document.querySelector(".result25").style.display = "block";
})
